...
<!--<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script> -->
 <!--   <link rel="Stylesheet" type="text/css" href="homemain.css" >-->
    ...
    <style type="text/css">
	       body { 
  background: url("backg1.jpg") no-repeat center center fixed; 
...
<BR><BR>
<center>
 <img src="clean india.png" alt="clean India" style=" width:75%; height:95% !important; border-radius:10px"></center>
 ...
 <div class="container-fluid" >
     <div class="row">
<div class="container-fluid col bg_img" style="float:right;margin-right:20%;margin-top:10%"> 
...
<form method="post" action="userreg.php">
    ...
    <input for="number" type="number" name="number">
    <label for="lat">Address : </label>
    <input for="lat" type="text" name="address"
    <label for="long">City: </label>
    <input for="long" type="text" name="city">
    <br><br>
